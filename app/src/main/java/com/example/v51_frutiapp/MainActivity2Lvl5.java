...
public class MainActivity2Lvl5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2_lvl5);
    ...
    public void numRandom (){
        ...
        if (iScore <= 49) {
            ...
            Intent lvl2 = new Intent(this, MainActivity2Lvl6.class);
