...
public class MainActivity2Lvl7 extends AppCompatActivity {

    // Declaramos los Objetos que usaremos a la hora de pasar los adtos
    private TextView tvName, tvScore;
    private ImageView ivNum1, ivNum2, ivChances;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2_lvl7);
    ...
    public void numRandom (){
        ...
        if (iScore <= 69) {
            ...
            // Estrucutura Condicional para Funcionamiento de la División
            // Ponemos una Estructura Repetitiva para la División
            ...
            Intent lvl2 = new Intent(this, MainActivity2Lvl8.class);
