...
/*
Recuerda poner la línea de código en el AndroidManifest.xml:
android:configChanges="orientation|screenSize"
con el fin de evitar que la app se reinicie cuando se rota la pantalla
Ejemplo:
<activity
...
public class MainActivity2Lvl1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2_lvl1);
    ...
    public void numRandom (){
        ...
        if (iScore <= 9) {
            ...
            // Poner el Candado para que no pase de 10
            if (iRes <= 10) {
                // Ponemos una Estructura Repetitiva
            ...
            } else { // Metodo recursivo para que se llame así mismo
                // Con el fin de que el número no exceda de 10
                numRandom();
            }

        } else {
            // En caso de que sea mayor a 9 pasamos a la siguiente Activity
            Intent lvl2 = new Intent(this, MainActivity2Lvl2.class);
