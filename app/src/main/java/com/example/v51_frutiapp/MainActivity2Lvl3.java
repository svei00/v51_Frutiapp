...
public class MainActivity2Lvl3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2_lvl3);
    ...
    public void numRandom (){
        ...
        if (iScore <= 29) {
            ...
            Intent lvl2 = new Intent(this, MainActivity2Lvl4.class);
