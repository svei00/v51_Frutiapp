...
public class MainActivity2Lvl6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity2_lvl6);
    ...
    public void numRandom (){
        ...
        if (iScore <= 59) { // Cambiar el 60 por el final o continuar con divisiones
            ...
            Intent lvl2 = new Intent(this, MainActivity2Lvl7.class);
